const CACHE='adhome-presentes-v049-1';
const SHELL=['./','./index.html','./styles.css?v=046','./reset041.js?v=046','./app1a.js?v=046','./app1b.js?v=046','./app2.js?v=046','./app3.js?v=046','./app4.js?v=046','./app5.js?v=046','./app6.js?v=046','./app7.js?v=046','./app8.js?v=046','./app10.js?v=046','./app11.js?v=046','./app12.js?v=046','./app13.js?v=049','./app14.js?v=049','./app15.js?v=049','./manifest.webmanifest','./logo.png','./icon-192.png','./icon-512.png','https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2','https://unpkg.com/html5-qrcode@2.3.8/html5-qrcode.min.js','https://cdn.jsdelivr.net/npm/jspdf@2.5.1/dist/jspdf.umd.min.js','https://cdn.jsdelivr.net/npm/xlsx@0.18.5/dist/xlsx.full.min.js'];
...
self.addEventListener('push',event=>{
  event.waitUntil((async()=>{
    ...
    if(visible){visible.postMessage({type:'PUSH_ORDER',data});return}
    await self.registration.showNotification(data.title||'ADHOME · Nuevo pedido',{
